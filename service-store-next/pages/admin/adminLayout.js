                ...
                <ul className="nav flex-column">
                  ...
                  <li className="nav-item">
                    <a className="nav-link">
                      ...
                      <b className="text-white">
                        {" "}
                        <Link href="/admin/entities/users">
                          <span
                            style={{ cursor: "pointer" }}
                            className="text-white"
                          >
                  ...
                  <li className="nav-item">
                    <a className="nav-link">
                      ...
                      <b className="text-white">
                        {" "}
                        <Link href="/admin/entities/requests">
                          <span
                            style={{ cursor: "pointer" }}
                            className="text-white"
                          >
                  ...
                  <li className="nav-item">
                    <a className="nav-link">
                      ...
                      <b className="text-white">
                        {" "}
                        <Link href="/admin/entities/offers">
                          <span
                            style={{ cursor: "pointer" }}
                            className="text-white"
                          >
                  ...
                  <li className="nav-item">
                    <a className="nav-link">
                      ...
                      <b className="text-white">
                        {" "}
                        <Link href="/admin/entities/contracts">
                          <span
                            style={{ cursor: "pointer" }}
                            className="text-white"
                          >
                  ...
                  <li className="nav-item">
                    <a className="nav-link">
                      ...
                      <b className="text-white">
                        {" "}
                        <Link href="/admin/entities/lpmessages">
                          <span
                            style={{ cursor: "pointer" }}
                            className="text-white"
                          >
